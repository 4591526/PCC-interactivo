...
if opciones == "Mi primer código en Python":
    st.markdown(f'<h2 style="font-size: 42px; text-align: center; color: #6C6C93">Mi primer código en Python</h2>', unsafe_allow_html=True)
    ...
    # Descripción general
    st.write("""
    **Visual Studio Code (VS Code)** es un editor de código fuente gratuito y multiplataforma, desarrollado por Microsoft.  
    """)

    st.markdown("""
    - Es un programa ligero y rápido.  
    - Te permite instalar extensiones para distintos lenguajes de programación (Python, JavaScript, R, C++, etc.). 
    - Te permite manejar carpetas y archivos fácilmente desde una sola ventana.    
    - No necesitas cambiar de ventana para usar la línea de comandos, ya que integra una terminal.
    - Puedes modificar atajos, apariencia y configuraciones para adaptarlo a tu estilo de trabajo.  
    - Te permite manejar control de versiones desde el propio editor e integrarlo a GitHub.
    """)
    ...
    st.markdown(f'<h2 style="font-size: 30px; text-align: center; ">VS Code + Jupyter Notebook</h2>', unsafe_allow_html=True)
